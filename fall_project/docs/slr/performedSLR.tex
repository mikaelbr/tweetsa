In this section it is described how the systematic literature review was conducted and the result of the review. The first section, \Cref{sec:slrintro}, covers the introduction and defines our research questions. The review method is described in \Cref{sec:slrmethod} and the result in \Cref{sec:slrresults}.
