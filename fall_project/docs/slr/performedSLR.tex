In this section it is described how the structured literature review was conducted and the result of the review. The first section, \Cref{sec:slrintro}, covers the introduction and defines our research questions. The review method is described in \Cref{sec:slrmethod} and the result in \Cref{sec:slrresults}.
...
\begin{description}
	...
	\item[3. Specifying the research question(s)] \hfill \\
		We defined the RQs based on what we felt needed to be researched when finding the state-of-the-art for sentiment analysis systems on Twitter. The RQs can be seen in \Cref{sec:slrintro}. 
...
In this section the result of the systematic literature review is presented. In \Cref{sec:selected} all of the extracted data from the selected studies are presented. The assessed quality is also presented. 

In \Cref{sec:stateofart} the answers to our research questions are given. 
