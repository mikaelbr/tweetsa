...
The assumption of conditionally independent attributes makes this classifier best suited for handling bag-of-words models, which is a collection of unigrams.