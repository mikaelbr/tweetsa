...
Sentiment Analysis (or opinion mining) on Twitter has become very popular in later years. Sentiment and opinion data has a wide area of in fields like marketing research, end-user product research, reviews and more. This has made it a very appealing topic for research.

For this report we conduct a literature search review to define the current state-of-the-art for sentiment analysis systems on Twitter data, and we propose an architecture for building such a system. Our proposed system works as a layer on top of the Twitter API, and as such is very well documented, and a lot of developers are already familiar with it. The API layer and the sentiment classification system works in a very asynchronous manner which allows for parallel operations and a horizontally scalable system. 
...
This specialization project is conducted as a part of a Master's thesis at the Norwegian University of Technology (NTNU) in Trondheim. We have used this project as a mean of gaining sufficient knowledge about and defining the state-of-the-art for sentiment analysis systems. This state-of-the-art are to be used as a basis for our Master's thesis in our last semester of our studies at NTNU. 
