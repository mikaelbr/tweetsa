...
Sentiment Analysis (or opinion mining) on Twitter has become very popular in recent years. Sentiment and opinion data has a wide range of applications in fields like marketing research, end-user product research, reviews and more. This has made it a very appealing topic for research.

In the report a structured literature review is conducted to define the current state-of-the-art for sentiment analysis systems on Twitter data, and an architecture is proposed for building such a system. The proposed system works as a layer on top of the Twitter API, and as such is thoroughly documented, and a lot of developers are already familiar with it. The API layer and the sentiment classification system work in a heavily asynchronous manner which allows for parallel operations and a horizontally scalable system. 
