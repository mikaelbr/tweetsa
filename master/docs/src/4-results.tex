...
\caption[Eurovision Song Contest experiment result]{The results of the Eurovision Song Contest versus the predictions by using the SentiStack visualisation application.}
