...
Class & \multicolumn{1}{c}{Training} & \multicolumn{1}{c}{Devel.} &\multicolumn{1}{c}{Test} &\multicolumn{1}{c}{NTNU}  \\
\noalign{\smallskip}\hline\noalign{\smallskip}
Positive & 3270 & 575 & 368 & 142\\ 
Neutral  & 4151 & 739 & 144 & 232\\ 
Negative & 1288 & 340 & 176 & 86\\ 
Total & 8709 & 1654 & 688 & 461\\
\noalign{\smallskip}\hline\noalign{\smallskip}
\end{tabular}
...
The base parent model implements methods for training the machine learning algorithm and for predicting either a set of documents or one document. For simple algorithms as NB, SVM and MaxEnt, these generic methods can be used, but the TwoStep and Boosting model have their own implementation. 
