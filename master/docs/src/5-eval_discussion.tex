...
The discussion is split into to parts; firstly the results and experiments are discussed, then the 
visualisation applications. The visualisation application discussion also contains thoughts about
the generic system architecture.

\section{Experiments Discussion}


\section{Architecture and Visualisation Discussion}
